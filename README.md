...
### header H3 Le problème abordé dans la visualisation :
...
### header H3 À qui s’adresse la visualisation, quelles tâches seront effectuées au travers de votre projet ?
...
### header H3 Les sources de données identifiées, pour chacune identifier leur intérêt principal et leurs limites potentielles :
